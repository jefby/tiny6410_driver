/*
 *
 *	°´¼üÇı¶¯å Ôö¼ÓÁËÉè±¸Ö»ÄÜ±»´ò¿ªÒ»´ÎµÄ¹¦ÄÜ£¬ÊµÏÖ·½·¨: Ê¹ÓÃĞÅºÅÁ¿»úÖÆ
 *	
 *	Author:jefby
...
#include <mach/gpio-bank-l.h>//¶¨ÒåÁËGPlCON
...
{ 
    ...
    int err = 0;
   //use atomic
	if(down_interruptible(&buttons_lock))//·µ»Ø·ÇÁãÖµ£¬±íÊ¾²Ù×÷±»ÖĞ¶Ï
		return -ERESTARTSYS;
